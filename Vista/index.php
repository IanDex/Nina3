...
<h1>Cristtian</h1>
              ...
              <div id="fileTreeDemo_1" class=""></div>
                    </div>
          </div>
        </div>
    ...
    <script src="lol/jquery.easing.js" type="text/javascript"></script>
    <script src="lol/jqueryFileTree.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready( function() {
            ...
            $('#fileTreeDemo_1').fileTree({ root: '../', script: 'lol/connectors/jqueryFileTree.php' }, function(file) {
                alert(file);
                var filenameWithExtension = file.replace(/^.*[\\\/]/, '');
